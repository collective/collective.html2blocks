...
# collective.html2blocks build configuration file
...
project = "collective.html2blocks"
author = "Érico Andrei"
...
linkcheck_ignore = [
    ...
    r"https://github.com/collective/collectivehtml2blocksdocumentation/issues/new",
    # Ignore github.com pages with anchors
    r"https://github.com/.*#.*",
    # Ignore other specific anchors
]
linkcheck_allowed_redirects = {  # TODO: Confirm usage of linkcheck_allowed_redirects
    # All HTTP redirections from the source URI to the canonical URI will be treated as
    # "working".
}
...
html_theme_options = {
    ...
    # "extra_footer": """<p>Example `extra_footer` content. License info. Trademark info
    # and usage.</p>
    # <p>Pull request previews by
    ...
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/collective/collectivehtml2blocksdocumentation",
    ...
    "logo": {
        "text": "collective.html2blocks",
    },
    "navigation_with_keys": True,
    "path_to_docs": "docs/collective.collectivehtml2blocksdocumentation",
    "repository_branch": "main",
    "repository_url": "https://github.com/collective/collectivehtml2blocksdocumentation",
...
# html_context = {
#     "edit_page_url_template": "https://github.com/collective/collectivehtml2blocksdocumentation/edit/main/docs/",
# }
...
htmlhelp_basename = "collective.html2blocksDocumentation"
...
latex_documents = [
    (
        "index",
        "collective.html2blocksDocumentation.tex",
        "collective.html2blocks Documentation",
